...
### **[DCID](https://datacommons.org/browser/dcid)**
...
The unit of measurement. Examples include [kilowatt hours](https://datacommons.org/browser/KilowattHour), [inches](https://datacommons.org/browser/Inch), and [Indian Rupees](https://datacommons.org/browser/IndianRupee). A complete list of properties can be found in the [browser](https://datacommons.org/browser/unit).