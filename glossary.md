...
Entities that describe specific geographic locations. Use the search box in [Place Explorer](https://datacommons.org/place) to search for places in the graph, or view the [Knowledge Graph Browser entry for Place](https://datacommons.org/browser/Place) for a full view of the node.
...
A complete list of properties can be found in the [knowledge graph browser](https://datacommons.org/browser/scalingFactor).
