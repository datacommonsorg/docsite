...
<pre>
https://api.datacommons.org/sdmx/v3/availability/dataflow/DC/DF_OBS/1.0.0/*/<var>OBSERVATION_FIELD</var>?c[variableMeasured]=<var>VARIABLE_DCIDS</var>&c[<var>OBSERVATION_FIELD</var>]=<var>ENTITY_DCIDS</var>&...c[<var>TIME_PERIOD</var>]=<var>DATES</var>
</pre>
...
| For <code>observationAbout</code>, custom observation properties<em>,</em> and <code>provenance</code>: comma-separated list of DCID values for the selected observation property. <br/>
For all others: see <a href="https://docs.datacommons.org/custom_dc/custom_data.html#exp_csv">Prepare and load your own data - Docs</a>.</li>
</ul>
<br>
...
Optional</td>
      <td>Filter results by a specific time period. If not specified, defaults to all results.</td>
      <td>Comma-separated dates, in the format <em>YYYY</em>, <em>YYYY</em>-<em>MM</em>, or <em>YYYY</em>-<em>MM</em>-<em>DD</em>.</td>
    </tr>
  </tbody>
</table>
...
undefined#### Example 2: Get places that have data for a specific variable, filtered by type and parent place
...
undefined#### Example 3: Get all the entities that have data for a specific value of a custom property, for a multi-entity variable
