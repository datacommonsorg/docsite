...
<div markdown="span" class="alert alert-warning" role="alert" style="color:black; font-size: 0.8em">
    ...
    To retrieve single points within a series, use [v1/bulk/observations/point]({{ site.baseurl }}/api/rest/v1/observations/point)<br />.
    For single queries with a simpler output, see the [simple version]({{ site.baseurl }}/api/rest/v1/observations/series) of this endpoint.
</div>
...
Get total annual electric power consumption (DCID: `Annual_Consumption_Coal_ElectricPower`) and water withdrawal rates (DCID: `WithdrawalRate_Water`) for both Viriginia (DCID: `geoId/51`) and Texas (DCID: `geoId/48`)
