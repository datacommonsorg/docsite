...
| property <br /> <required-tag>Required</required-tag> | string | [Relation expression](api/rest/v2/index.html#relation-expressions) that represents the relation of the given nodes to the queried entities. Note that this should always end with `->dcid` |
