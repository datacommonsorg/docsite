...
3. Use the [Data Commons Knowledge Graph Browser](https://datacommons.org/browser) to
...
The knowledge graph browser [country/USA](https://datacommons.org/browser/country/USA)
