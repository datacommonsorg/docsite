...
1. Optionally, configure an AI agent to send NL queries to the MCP server (via an LLM). See [Use MCP tools](mcp.md).
1. If you want to customize the look of the feel of the site, see [Customize the site](/custom_dc/custom_ui.html) and [Build a custom image](images.md).
