...
* `measuredProperty`: This is a property of the thing being measured. It must be a `domainIncludes` property of the `populationType` you have specified. In this example, it is the prevalance of smoking, represented as a property called `cigaretteSmoker` of persons being measured.
